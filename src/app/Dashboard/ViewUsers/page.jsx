...
const ViewUsers = () => {
    ...
    return (
        <ProtectedRoute>
            <h5 className="text-2xl font-medium">All Users Table</h5>
            {deleteOpen && (
                <div className="fixed inset-0 bg-gray-300 bg-opacity-5 flex flex-col items-center justify-center z-50">
                    <div className="flex flex-col bg-white rounded-lg p-5 gap-4 z-50">
                        ...
                        <div className="flex gap-4 justify-center">
                            <button onClick={() => handleDelete(userToDelete)} className="bg-[#FF6764] rounded-full px-4 py-1 text-white w-fit">Delete</button>
            ...
            {updateOpen && (
                <div className="fixed inset-0 bg-gray-300 bg-opacity-5 flex flex-col items-center justify-center z-50">
                    <form className="flex flex-col bg-white rounded-lg p-5 gap-4 z-50">
                        ...
                        <div className="flex gap-4 justify-center">
                            {/* <button onClick={(e) => handleUpdate(e, userUpdate)} className="bg-[#FF6764] rounded-sm px-4 py-1 text-white w-fit" disabled={isSubmitting}>{isSubmitting ? 'Updating...' : 'Update'}</button> */}
