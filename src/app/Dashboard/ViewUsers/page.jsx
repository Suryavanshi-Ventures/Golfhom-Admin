...
const ViewUsers = () => {
  ...
  const handleDelete = async (userData) => {
    try {
      ...
      setViewListUsers((prevUserList) =>
        prevUserList.filter((user) => user.id !== userData)
      );
        ...
        <table className="w-full table-auto">
          <thead className="font-semibold text-sm">
            <tr>
              ...
              <th className="py-8 text-center bg-[#F7F7F7] rounded-tr-lg pr-2 lg:pr-0">
                Delete
              </th>
          ...
          <tbody className="w-full">
            {viewListUsers?.map((data) => (
              <React.Fragment key={data.id}>
                <tr>
                  <td className="text-start px-8 pt-8 pb-6">
                  ...
                  <td className="lg:pl-6 lg:pr-0 text-center">
                    <button
                      className="text-center text-white px-6 py-1.5 rounded-sm "
