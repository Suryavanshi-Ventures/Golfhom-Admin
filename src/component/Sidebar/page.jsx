                ...
                <div className='py-5 px-3 overflow-y-auto h-screen shadow-lg'>
                    <div className='px-5 pb-5'>
                        ...
                        <Link href="/Dashboard" className='cursor-pointer'>
                            <div className={`${isLinkActive('/Dashboard') ? 'text-white bg-[#FF6764] opacity-[0.8] w-full' : 'bg-white'} py-2 px-3 flex gap-2 rounded-lg inline-block`}>
                    ...
                    <div className='p-5 flex flex-col'>
                        ...
                        <Link href="/Dashboard/ViewUsers" className="my-1 flex gap-2 cursor-pointer">
                            <div className={`${isLinkActive('/Dashboard/ViewUsers') ? 'text-white bg-[#FF6764] opacity-[0.8] w-full' : 'bg-white'} py-2 px-3 flex gap-2 rounded-lg inline-block`}>
                        ...
                        <Link href="/Dashboard/ViewAdmin" className="my-1 flex gap-2 cursor-pointer">
                            <div className={`${isLinkActive('/Dashboard/ViewAdmin') ? 'text-white bg-[#FF6764] opacity-[0.8] w-full' : 'bg-white'} py-2 px-3 flex gap-2 rounded-lg inline-block`}>
                        ...
                        <Link href="/Dashboard/ViewBooking" className="my-1 flex gap-2 cursor-pointer">
                            <div className={`${isLinkActive('/Dashboard/ViewBooking') ? 'text-white bg-[#FF6764] opacity-[0.8] w-full' : 'bg-white'} py-2 px-3 flex gap-2 rounded-lg inline-block`}>
                    ...
                    <div className='p-5 flex flex-col'>
                        ...
                        <Link href="/Dashboard/ViewProperty" className="my-1 flex gap-2 cursor-pointer">
                            <div className={`${isLinkActive('/Dashboard/ViewProperty') ? 'text-white bg-[#FF6764] opacity-[0.8] w-full' : 'bg-white'} py-2 px-3 flex gap-2 rounded-lg inline-block`}>
                        ...
                        <Link href="/Dashboard/ViewBlog" className="my-1 flex gap-2 cursor-pointer">
                            <div className={`${isLinkActive('/Dashboard/ViewBlog') ? 'text-white bg-[#FF6764] opacity-[0.8] w-full' : 'bg-white'} py-2 px-3 flex gap-2 rounded-lg inline-block`}>
                        ...
                        <Link href="/Dashboard/ViewMessage" className="my-1 flex gap-2 cursor-pointer">
                            <div className={`${isLinkActive('/Dashboard/ViewMessage') ? 'text-white bg-[#FF6764] opacity-[0.8] w-full' : 'bg-white'} py-2 px-3 flex gap-2 rounded-lg inline-block`}>
                    ...
                    <button className={`${isActive ? 'text-white bg-[#FF6764] opacity-[0.8] w-full' : 'bg-white'} py-2 my-4 px-8 flex gap-2 rounded-lg inline-block flex items-center gap-2 cursor-pointer`} onClick={handleLogout}>
